...
scenarios = [{:id=> 1, :story => 'It\'s Friday night and you want to go to... ', 
            ...
            {:id=> 96, :story => 'You...', 
                          :choice_1=> 302, :choice_2 => 303, :choice_3=> nil },
            {:id=> 97, :story => 'You take another test after studying more, and get the score you wanted. You…',
              :choice_1=> 203, :choice_2=> nil, :choice_3=> nil},
            {:id=> 98, :story=> 'You take another test after studying more, but you get a lower score than before. You…',
            ...
            {:id=> 106, :story => 'You managed to get a decent job and have an average life. END', 
                          :choice_1=> nil, :choice_2 => nil, :choice_3=> nil},
            {:id=> 107, :story => 'You...', 
                          :choice_1=> 311, :choice_2 => nil, :choice_3=> nil},
            {:id=> 108, :story=> 'You end up getting into your dream college. You...',
              :choice_1=> 206, :choice_2=> nil, :choice_3=> nil},
            {:id=> 109, :story => 'You...',
            :choice_1=> 207, :choice_2=> 208, :choice_3=> nil},
            ...
            :choice_1=> 211, :choice_2=> nil, :choice_3=> nil},
            {:id=> 114, :story => 'You\'ve been let go due to being the newest member and to the downturn in the economy. You...',
            ...
            {:id=> 122, :story => 'You didn\'t know this would happen so you..', 
                          :choice_1=> 214, :choice_2 => nil, :choice_3=> nil},
            {:id=> 123, :story => 'You didn\'t have anything saved so you ...', 
                          :choice_1=> 215, :choice_2 => 216, :choice_3=> nil},
            {:id=> 124, :story => 'You became a wealthy business person. You\'re forever alone. END', 
                          :choice_1=> nil, :choice_2 => nil, :choice_3=> nil},
...
{:id=> 203, :option=> 'You get into the college you wanted', :scenario_id=> 108},
{:id=> 204, :option=> 'You use your highest score for college application', :scenario_id=>109},
{:id=> 205, :option=> 'You take the test again, and finally get the score you wanted', :scenario_id=> 110},
...
{:id=> 212, :option=> 'Didn\'t think this would happen to you', :scenario_id=> 122},
